...
export class StableImageCoreStrategy implements ModelGenerationStrategy {
  ...
  prepareParams(
    ...
    const preparedParams: GenerationParams = {
      // Convert generic parameters to Stable Image Core-specific format
      ...
      // Stable Image Core-specific parameters with fallback values
      ...
      // Optional Stable Image Core-specific parameters
  ...
  // Transform prompts to Stable Image Core's text_prompts format
